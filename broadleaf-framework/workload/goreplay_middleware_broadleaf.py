    ...
    for raw_line in fileinput.input():
        ...
        if (request_type_id == 1):
            ...
            if (match and jsessionid_site != ""):
                ...
                log('find cookie_JSESSIONID in request header(' + ori_jsessionid_site + '), replace it to (' + jsessionid_site + ')!')
        ...
        if (request_type_id == 3):
            ...
            if (match):
                ...
                log('find set-cookie JSESSIONID in response: ' + jsessionid_site)
