...
SENDER = {"name": "test-sender", "address": "test-sender@localhost", "password": "123456"}
RECEIVER = {"name": "test-receiver", "address": "test-receiver@localhost", "password": "654321"}
...
def handle_args():
    parser = argparse.ArgumentParser(
        description="A workload generator for HedWig server")
