...
public class TestGlyphRendererPanktiGen {
    ...
    public void testMidValue1() {
        try {
            ...
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue1-receiving.xml").getFile());
    ...
    public void testMidValue2() {
        try {
            ...
            "  <glyphDescription class=\"org.apache.fontbox.ttf.GlyfSimpleDescript\">" +
            "    <instructions>" +
            "      <int>64</int>" +
            "      <int>72</int>" +
            "      <int>232</int>" +
            ...
            "      <int>93</int>" +
            "    </instructions>" +
            "    <contourCount>2</contourCount>" +
            "    <endPtsOfContours>" +
            "      <int>13</int>" +
            "      <int>25</int>" +
            "    </endPtsOfContours>" +
            "    <flags>EzQSNjMyABUUACMiJCYlFBYzMjY1NCYjIgY=</flags>" +
            "    <xCoordinates>" +
            "      <short>82</short>" +
            "      <short>82</short>" +
            "      <short>220</short>" +
    ...
    public void testMidValue3() {
        try {
            ...
            "      <int>27</int>" +
            "    </endPtsOfContours>" +
            "    <flags>MxEhIBcWFhUUBgYHBiMjGRkZMzI2NjU0JicmIw==</flags>" +
            "    <xCoordinates>" +
            "      <short>149</short>" +
            "      <short>149</short>" +
            "      <short>624</short>" +
    ...
    public void testMidValue5() {
        try {
            ...
            "      <int>93</int>" +
            "    </instructions>" +
            "    <contourCount>1</contourCount>" +
            "    <endPtsOfContours>" +
            "      <int>22</int>" +
            "    </endPtsOfContours>" +
            "    <flags>EzM1NDY2MzIXByYjIgYVFTMVIxEhESM=</flags>" +
            "    <xCoordinates>" +
            "      <short>24</short>" +
            "      <short>180</short>" +
            "      <short>180</short>" +
    ...
    public void testMidValue7() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue7-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue8() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue8-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue9() {
        try {
            ...
            "      <int>31</int>" +
            "    </endPtsOfContours>" +
            "    <flags>EyEyFxYWEhUUBwYHBgcGIyEBETMyNz4+PjU0JiYnJiM=</flags>" +
            "    <xCoordinates>" +
            "      <short>148</short>" +
            "      <short>689</short>" +
            "      <short>872</short>" +
    ...
    public void testMidValue10() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue10-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue12() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue12-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue16() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue16-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue17() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue17-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue22() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue22-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue26() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue26-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue28() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue28-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue29() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue29-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
    ...
    public void testMidValue39() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.fontbox.ttf.GlyphRenderer.midValue39-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            GlyphRenderer receivingObject = (GlyphRenderer) xStream.fromXML(receivingXML);
            String returnedXML = 
