...
public class TestPDDeviceRGBPanktiGen {
    ...
    public void testToRGB1() {
        ...
        "  </initialColor>" +
        "  <awtColorSpace class=\"java.awt.color.ICC_ColorSpace\" serialization=\"custom\">" +
        ...
        "      </default>" +
        "    </java.awt.color.ColorSpace>" +
        "    <java.awt.color.ICC__ColorSpace>" +
        "      <default>" +
        "        <needScaleInit>false</needScaleInit>" +
        "        <diffMinMax>" +
        "          <float>1.0</float>" +
        "          <float>1.0</float>" +
        "          <float>1.0</float>" +
        ...
        "          <float>0.0</float>" +
        "        </minVal>" +
        "        <thisProfile class=\"java.awt.color.ICC_ProfileRGB\" serialization=\"custom\">" +
        "          <java.awt.color.ICC__Profile>" +
        "            <default>" +
        "              <iccProfileSerializedDataVersion>1</iccProfileSerializedDataVersion>" +
        "            </default>" +
        "            <string>CS_sRGB</string>" +
        "            <null/>" +
        "          </java.awt.color.ICC__Profile>" +
        "        </thisProfile>" +
        "      </default>" +
