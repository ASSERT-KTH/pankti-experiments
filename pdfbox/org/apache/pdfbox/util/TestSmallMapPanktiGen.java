...
public class TestSmallMapPanktiGen {
    ...
    public void testSize1() {
        try {
            ...
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.util.SmallMap.size1-receiving.xml").getFile());
    ...
    public void testSize3() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.util.SmallMap.size3-receiving.xml").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            SmallMap receivingObject = (SmallMap) xStream.fromXML(receivingXML);
            String returnedXML = 
