...
public class TestPDFTextStripperPanktiGen {
    ...
    public void testWithin1() {
        try {
            ...
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.text.PDFTextStripper.within1-receiving.txt").getFile());
            ...
            String paramsXML = "<object-array><float>122.25</float><float>122.25</float><float>0.1</float></object-array>";
    ...
    public void testWithin2() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.text.PDFTextStripper.within2-receiving.txt").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            PDFTextStripper receivingObject = (PDFTextStripper) xStream.fromXML(receivingXML);
            String returnedXML = "<boolean>true</boolean>";
            boolean returnedObject = (Boolean) xStream.fromXML(returnedXML);
            String paramsXML = "<object-array><float>89.25</float><float>89.25</float><float>0.1</float></object-array>";
            Object[] paramObjects = (Object[]) xStream.fromXML(paramsXML);
            float paramObject1 = (Float) paramObjects[0];
            float paramObject2 = (Float) paramObjects[1];
            float paramObject3 = (Float) paramObjects[2];
    ...
    public void testWithin3() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.text.PDFTextStripper.within3-receiving.txt").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            PDFTextStripper receivingObject = (PDFTextStripper) xStream.fromXML(receivingXML);
            String returnedXML = "<boolean>true</boolean>";
    ...
    public void testWithin4() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.text.PDFTextStripper.within4-receiving.txt").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            PDFTextStripper receivingObject = (PDFTextStripper) xStream.fromXML(receivingXML);
            String returnedXML = "<boolean>false</boolean>";
            boolean returnedObject = (Boolean) xStream.fromXML(returnedXML);
            String paramsXML = "<object-array><float>107.25</float><float>89.25</float><float>0.1</float></object-array>";
            Object[] paramObjects = (Object[]) xStream.fromXML(paramsXML);
            float paramObject1 = (Float) paramObjects[0];
            float paramObject2 = (Float) paramObjects[1];
            float paramObject3 = (Float) paramObjects[2];
    ...
    public void testWithin5() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.text.PDFTextStripper.within5-receiving.txt").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            PDFTextStripper receivingObject = (PDFTextStripper) xStream.fromXML(receivingXML);
            String returnedXML = "<boolean>false</boolean>";
            boolean returnedObject = (Boolean) xStream.fromXML(returnedXML);
            String paramsXML = "<object-array><float>122.25</float><float>107.25</float><float>0.1</float></object-array>";
            Object[] paramObjects = (Object[]) xStream.fromXML(paramsXML);
            float paramObject1 = (Float) paramObjects[0];
            float paramObject2 = (Float) paramObjects[1];
            float paramObject3 = (Float) paramObjects[2];
