...
public class TestPageDrawerPanktiGen {
    ...
    public void testClampColor1() {
        try {
            ...
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.rendering.PageDrawer.clampColor1-receiving.txt").getFile());
            ...
            String paramsXML = "<object-array><float>1.0</float></object-array>";
    ...
    public void testClampColor2() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.rendering.PageDrawer.clampColor2-receiving.txt").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            PageDrawer receivingObject = (PageDrawer) xStream.fromXML(receivingXML);
            String returnedXML = "<float>1.0</float>";
    ...
    public void testClampColor3() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.rendering.PageDrawer.clampColor3-receiving.txt").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            PageDrawer receivingObject = (PageDrawer) xStream.fromXML(receivingXML);
            String returnedXML = "<float>1.0</float>";
    ...
    public void testClampColor4() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            File filereceiving = new File(classLoader.getResource("org.apache.pdfbox.rendering.PageDrawer.clampColor4-receiving.txt").getFile());
            Scanner scannerreceiving = new Scanner(filereceiving);
            String receivingXML = scannerreceiving.useDelimiter("\\A").next();
            PageDrawer receivingObject = (PageDrawer) xStream.fromXML(receivingXML);
            String returnedXML = "<float>1.0</float>";
